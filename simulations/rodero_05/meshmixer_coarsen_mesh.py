...
# ---- Step 9: Set materials
print('Step 9: Set materials...')
import numpy as np
import pandas as pd
from scipy.spatial import cKDTree
...
import h5py
with h5py.File('./rodero_05_coarse_'+resolution +'.h5', 'r') as f:
...
np.save('./rodero_05_coarse_'+resolution +'_tv.npy', coarse_tv)
print('Saved rodero_05_coarse_'+resolution +'_tv.npy')